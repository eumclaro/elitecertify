...
export default function AuditLogs() {
  ...
  const actionLabels: Record<string, { label: string; color: string }> = {
    ...
    'EXAM_CREATED':                   { label: 'Prova Criada',         color: 'bg-blue-500/10 text-blue-600 border-blue-500/20' },
    'EXAM_UPDATED':                   { label: 'Prova Editada',        color: 'bg-blue-500/10 text-blue-600 border-blue-500/20' },
    'EXAM_DELETED':                   { label: 'Prova Excluída',       color: 'bg-red-500/10 text-red-600 border-red-500/20' },
    'EXAM_RELEASED':                  { label: 'Prova Liberada',       color: 'bg-emerald-500/10 text-emerald-600 border-emerald-500/20' },
    'EXAM_RELEASE_REVOKED':           { label: 'Acesso Revogado',      color: 'bg-orange-500/10 text-orange-600 border-orange-500/20' },
    'EXAM_TEMPLATE_LINKED':           { label: 'Template Vinculado',   color: 'bg-blue-500/10 text-blue-600 border-blue-500/20' },
    'COOLDOWN_CLEARED_MANUALLY':      { label: 'Cooldown Removido',    color: 'bg-purple-500/10 text-purple-600 border-purple-500/20' },
    'INVITE_ACTIVATED':               { label: 'Convite Ativado',      color: 'bg-emerald-500/10 text-emerald-600 border-emerald-500/20' },
    'PASSWORD_RESET_REQUESTED':       { label: 'Reset de Senha',       color: 'bg-orange-500/10 text-orange-600 border-orange-500/20' },
    'STUDENT_CLASSES_UPDATED':        { label: 'Turmas Atualizadas',   color: 'bg-blue-500/10 text-blue-600 border-blue-500/20' },
    'STUDENT_DELETED':                { label: 'Aluno Excluído',       color: 'bg-red-500/10 text-red-600 border-red-500/20' },
    'STUDENT_PASSWORD_RESET_BY_ADMIN':{ label: 'Senha Resetada',       color: 'bg-orange-500/10 text-orange-600 border-orange-500/20' },
    'STUDENT_PROFILE_EDITED':         { label: 'Perfil Editado',       color: 'bg-blue-500/10 text-blue-600 border-blue-500/20' },
    'TEAM_PASSWORD_RESET':            { label: 'Senha da Equipe',      color: 'bg-orange-500/10 text-orange-600 border-orange-500/20' },
  };
